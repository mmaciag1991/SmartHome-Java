package com.sm.smarthome.CustomControls.Indicators;
...
public class CircularProgressIndicator extends Region {
    ...
    public CircularProgressIndicator() {
        getStylesheets().add(Application.class.getResource("Skins/circular-progress-indicator.css").toExternalForm());
