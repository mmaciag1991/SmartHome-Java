 ...
 */
package com.sm.smarthome.CustomControls.HanSolo.TimeControl;


import com.sm.smarthome.CustomControls.HanSolo.TimeControl.Fonts.Fonts;
...
public class TimeControl extends Region {
    ...
    // ******************** Constructors **************************************
    public TimeControl() {
        getStylesheets().add(TimeControl.class.getResource("/com/sm/smarthome/CustomControls/HanSolo/TimeControl/timecontrol.css").toExternalForm());
