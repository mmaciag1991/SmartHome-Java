...
package com.sm.smarthome.CustomControls.HanSolo.Funmenu;
...
public class FunMenu extends Region {
    private static final double                            PREFERRED_WIDTH       = 530;
    ...
    private static final double                            MAXIMUM_WIDTH         = 530;
    private static final double                            MAXIMUM_HEIGHT        = 45;
    ...
    private static final CssMetaData<FunMenu, Color>       ICON_COLOR            = FACTORY.createColorCssMetaData("-icon-color", s -> s.iconColor, Color.WHITE, true);
