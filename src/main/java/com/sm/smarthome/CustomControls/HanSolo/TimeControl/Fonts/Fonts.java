 ...
 */
package com.sm.smarthome.CustomControls.HanSolo.TimeControl.Fonts;
...
public class Fonts {
    ...
    static {
        try {
            robotoLightName   = Font.loadFont(Fonts.class.getResourceAsStream("/com/sm/smarthome/CustomControls/HanSolo/TimeControl/Fonts/Roboto-Light.ttf"), 10).getName();
            robotoRegularName = Font.loadFont(Fonts.class.getResourceAsStream("/com/sm/smarthome/CustomControls/HanSolo/TimeControl/Fonts/Roboto-Regular.ttf"), 10).getName();
