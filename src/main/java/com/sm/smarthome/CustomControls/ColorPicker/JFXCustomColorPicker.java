...
public class JFXCustomColorPicker extends Pane {
    ...
    private ArrayList<JFXCustomColorPicker.RecentColorPath> shapes = new ArrayList<>();
    private CachedTransition showAnimation;
    public JFXColorPickerUI hslColorPicker;
    ...
    public JFXCustomColorPicker() {
        ...
        for (int i = 0; i < shapesNumber; i++) {
            ...
            final JFXCustomColorPicker.RecentColorPath path = new JFXCustomColorPicker.RecentColorPath(startPoint,
                    curve0To,
                    outerCircleCurveTo,
                    curve1To,
                    innerCircleCurveTo);
        ...
        // init selection
        selectedPath.set((JFXCustomColorPicker.RecentColorPath) this.getChildren().get(shapesStartIndex));
    }
    ...
    final class RecentColorPath extends Path {
        JFXCustomColorPicker.PathClickTransition transition;
        ...
        RecentColorPath(final PathElement... elements) {
            ...
            this.transition = new JFXCustomColorPicker.PathClickTransition(this);
        }
