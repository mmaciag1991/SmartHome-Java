package com.sm.smarthome.CustomControls.Keyboard;

import com.sm.smarthome.CustomControls.Keyboard.Keyboard.SpecialKey;
import com.sm.smarthome.CustomControls.Keyboard.Keyboard.SpecialKey.Type;
import com.sm.smarthome.CustomControls.Keyboard.skins.KeyboardViewSkin;
...
public class KeyboardView extends Control {
    ...
    public final Keyboard loadKeyboard(Locale locale) {
        ...
        if (keyboard == null) {
            keyboard = loadKeyboard("keyboard-full-pl.xml");
        }
