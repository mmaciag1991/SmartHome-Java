...
public class SetupPage extends PageBase{
    ...
    public SetupPage(Engine engine){
        ...
        this.DisplayName = "leftButtonsPanel.setupButton";
            ...
            public void onCatalogActionEvent(CatalogAction action) {
                switch (action) {
                    case Open -> {
                        ...
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_QRCODE, "setupPage.SetupCatalog.QrCode", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_WIFI, "setupPage.SetupCatalog.Wifi", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_CROWN, "setupPage.SetupCatalog.Crown", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_CONSOLE, "setupPage.SetupCatalog.Console", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_ANDROID, "setupPage.SetupCatalog.AndroidDevices", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_QRCODE, "setupPage.SetupCatalog.QrCode", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_WIFI, "setupPage.SetupCatalog.Wifi", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_CROWN, "setupPage.SetupCatalog.Crown", UserPermissions.Administrator, engine, windowManager));
                        setupCatalog.Add(new StdCatalog(MaterialDesign.MDI_CONSOLE, "setupPage.SetupCatalog.Console", UserPermissions.Administrator, engine, windowManager));
